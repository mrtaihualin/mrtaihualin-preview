  ...
  function emptyHTML() {
    return '<div class="rh-empty">目前找不到完全符合的內容，可以換個說法，或直接從三個分類開始：' +
      '<div class="rh-empty-links">' +
        '<a href="/mrtaihualin-preview/blog.html#articles">泰語學習文章</a>' +
        '<a href="/mrtaihualin-preview/resources.html#video-learning">影音學習</a>' +
        '<a href="/mrtaihualin-preview/blog.html#selfstudy">自學資源</a>' +
      '</div></div>';
  }
