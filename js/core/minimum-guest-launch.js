...
(function (window, document) {
  ...
  if (parked.test(path)) {
    window.location.replace('/mrtaihualin-preview/games.html?guest_launch=1');
    return;
  }
  ...
  style.textContent = [
    ...
    '[data-mgl-parked],a[href="/mrtaihualin-preview/my-progress.html"],a[href="my-progress.html"],',
  ...
  function hideParkedUi() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll('a[href="/mrtaihualin-preview/my-progress.html"],a[href="my-progress.html"]'), function (link) {
