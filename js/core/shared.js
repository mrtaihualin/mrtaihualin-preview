...
window.goHome = function() {
  ...
  if (p.endsWith('index.html') || p === '/' || p.endsWith('/')) {
    ...
    window.location.href = '/mrtaihualin-preview/index.html';
  }
};
...
// ===================================================================
  ...
  window.submitFreebie = function(){
    ...
    setTimeout(function(){ location.href='/mrtaihualin-preview/thank-you.html'; }, 700);                  // 3) ไปดาวน์โหลดเสมอ
  };
  ...
  window.submitHomeFreebie = function(){
    ...
    setTimeout(function(){ location.href='/mrtaihualin-preview/thank-you.html'; }, 700);
  };
  ...
  ready(function () {
    try {
      ...
      style.textContent =
        ...
        // 🔑 2026-08-10 (Lin สั่ง: "ทำทุกหน้าให้เป็น 4 ไปเลย") — ลบกฎซ่อน #bottom-nav ถาวรบนหน้าเกมออกแล้ว
        //    กฎเดิม 2026-07-12 ซ่อนไว้เพราะตอนนั้นแถบล่างเป็นชุดเก่า 5-6 ปุ่มข้อความ (首頁/課程/...) กินที่เยอะบนจอเกม
        //    ตอนนี้เป็นชุดใหม่ 4 ไอคอนเล็กกว่ามาก Lin จึงให้มีเหมือนกันทั้งเว็บ
        //    (บรรทัด 'body.rg-fake-fullscreen #bottom-nav' ด้านบนยังอยู่ = ตอนกดเต็มจอยังซ่อนเหมือนเดิม)
        //    padding ล่างของ body ก็ต้องไม่ล้างทิ้งแล้ว ไม่งั้นเนื้อหาท้ายหน้าจะถูกแถบบัง
  ...
  ready(function () {
    try {
      ...
      function openGameExit(trigger) {
        ...
        leaveButton.onclick = function () { window.location.assign('/mrtaihualin-preview/games.html'); };
