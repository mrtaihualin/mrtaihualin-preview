(function (window, document) {
  ...
  try {
    ...
    window.localStorage.setItem('phase1_learning_owner_v1', '00000000-0000-4000-8000-000000000003');
    ['tone', 'reading', 'typing', 'wordorder', 'lego'].forEach(function (game) {
      window.localStorage.setItem('howto_tour_seen_' + game, '1');
    });
    window.localStorage.setItem('linvault_v1', JSON.stringify({ items: [
      { th: 'คุณ', readingTH: 'คุน', en: 'khun', zh: '你、您', aliases: ['คุน', 'คุร', 'kun'], source: 'reading-game', saved_at: '2026-08-29T09:05:00.000Z', synced: true, tags: [], provenance: [
        { source: 'tone-finder', saved_at: '2026-08-29T08:10:00.000Z' },
        { source: 'reading-game', saved_at: '2026-08-29T09:05:00.000Z' }
      ] },
      { th: 'กิน', readingTH: 'กิน', en: 'gin', zh: '吃', source: 'listening-game', saved_at: '2026-08-28T10:20:00.000Z', synced: true, tags: [], provenance: [
        { source: 'listening-game', saved_at: '2026-08-28T10:20:00.000Z' },
        { source: 'typing-game', saved_at: '2026-08-28T10:35:00.000Z' }
      ] },
      { th: 'ข้าว', readingTH: 'ข้าว', en: 'khâao', zh: '飯', source: 'tone-finder', saved_at: '2026-08-27T07:40:00.000Z', synced: true, tags: [], provenance: [
        { source: 'tone-finder', saved_at: '2026-08-27T07:40:00.000Z' }
      ] }
    ], pendingDeletes: {} }));
    window.localStorage.setItem('sentence_vault_v1', JSON.stringify({ items: [
      { th: 'คุณสบายดีไหม', readingTH: 'คุน-สะ-บาย-ดี-ไหม', en: 'khun sabaai dii mai', zh: '您好嗎？', aliases: ['คุน', 'คุร', 'kun'], source: 'reading-game', saved_at: '2026-08-29T09:15:00.000Z', synced: true, provenance: [
        { source: 'tone-finder', saved_at: '2026-08-29T08:15:00.000Z' },
        { source: 'reading-game', saved_at: '2026-08-29T08:45:00.000Z' },
        { source: 'listening-game', saved_at: '2026-08-29T09:00:00.000Z' },
        { source: 'typing-game', saved_at: '2026-08-29T09:15:00.000Z' }
      ] },
      { th: 'ผมกินข้าวอยู่ที่บ้าน', readingTH: 'ผม-กิน-ข้าว-อยู่-ที่-บ้าน', en: 'phǒm gin khâao yùu thîi bâan', zh: '我在家吃飯', source: 'lego', saved_at: '2026-08-28T11:30:00.000Z', synced: true, provenance: [
        { source: 'lego', saved_at: '2026-08-28T11:10:00.000Z' },
        { source: 'word-order', saved_at: '2026-08-28T11:30:00.000Z' }
      ] }
    ], pendingDeletes: {} }));
  ...
  window.__TASK3_UI_PREVIEW_NO_NETWORK__ = true;
  window.__TASK3_UI_PREVIEW_FIXTURE__ = fixture;
  ...
  window.fetch = function (input, options) {
    ...
    if (url && /\/assets\/flashcard-audio\/manifest\.json(?:$|[?#])/.test(url.href)) {
      return response({ consonants: {}, vowels: {} }, 200);
    }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    if (!/\/vault\.html$/i.test(window.location.pathname)) return;
    var host = document.querySelector('.vault-page');
    if (!host || document.getElementById('task3-preview-label')) return;
    var label = document.createElement('div');
    label.id = 'task3-preview-label';
    label.setAttribute('role', 'note');
    label.textContent = '預覽專用 · 記憶體範例資料 · 不連接帳號或資料庫';
    label.style.cssText = 'margin:0 0 12px;padding:9px 12px;border:1.5px solid #C8973A;border-radius:12px;background:#FFF8E8;color:#765113;text-align:center;font:800 12px/1.45 "Noto Sans TC",sans-serif;';
